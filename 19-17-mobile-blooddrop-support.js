    ...
    window.renderCheatsheetPanel = function(){
      ...
      Object.entries(RAW_DATA.Categories_de_points || {}).forEach(([key,value])=>{
        ...
        if([
          ...
          // Certains points de cette catégorie n'appartiennent pas à leur
          // propre canal (préfixe du code) mais à un vaisseau extraordinaire
          // ou à un autre repère précis (ex. Rn8 est le xì-crevasse du yīn
          // qiāo mài, pas du canal du Rein). getContextLabelForPoint() connaît
          // déjà ces exceptions — on les regroupe sous leur propre étiquette
          // plutôt que sous le canal physique du point.
